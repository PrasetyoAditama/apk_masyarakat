                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="tampilpengaduan2.php" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?php echo $id ?>">Verifikasi</a>
                                    <a href="tampilpengaduan2.php?op=hapus&Id=<?php echo $data['id_pengaduan'] ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                                </td>
                            </tr>
                                        ...
                                        <div class="modal-body">
                                            <form action="<?php $_SERVER['PHP_SELF'] ?>?op=Update" method="post">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="id" name="id" value="<?php echo $db->bacaData1('id_pengaduan', $id); ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="tgl" class="col-sm-2 col-form-label">Tanggal Pengaduan</label>
                                                    <div class="col-sm-10">
                                                        <input type="date" class="form-control" id="tgl" name="tgl" value="<?php echo $db->bacaData1('tgl_pengaduan', $id); ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="nik" class="col-sm-2 col-form-label">Nik</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="nik" name="nik" value="<?php echo $db->bacaData1('nik', $id); ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="nama" class="col-sm-2 col-form-label">Nama</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $db->bacaData1('nama', $id); ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="isi" class="col-sm-2 col-form-label">Isi Laporan</label>
                                                    <div class="col-sm-10">
                                                        <textarea type="text" class="form-control" name="isi" readonly><?php echo $db->bacaData1('isi_laporan', $id); ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="kodetarif" class="col-sm-2 col-form-label">Status</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="status" value="Proses" name="status" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-12">
